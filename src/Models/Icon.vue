...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'tool'">
      <path
        d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 0 0 5.4-5.4l-2.6 2.6-2.4-2.4Z"
      />
    </template>
    ...
    <template v-else-if="name === 'key'">
      <path
        d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777Zm0 0L15.5 7.5m0 0 3 3L22 7l-3-3"
      />
    </template>
    ...
    <template v-else-if="name === 'scale'">
      <path d="m16 16 3-8 3 8c-2 1.5-4 1.5-6 0" />
      <path d="m2 16 3-8 3 8c-2 1.5-4 1.5-6 0" />
